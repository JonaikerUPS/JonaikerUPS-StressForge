...
import { transformTaurusData } from '@/lib/chart-transformers';

export const TaurusDashboard = ({ rawData }: { rawData: any }) => {
  const data = transformTaurusData(rawData);

  return (
    <BaseDashboard title="Taurus Unified Report">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
        ...
        <div className="bg-white/80 border border-slate-200 shadow-sm backdrop-blur-xl p-6 rounded-2xl dark:bg-slate-900/50 dark:border-white/10 col-span-1 lg:col-span-2">
          <h4 className="text-slate-800 dark:text-slate-200 mb-4 font-semibold">Criteria Pass/Fail</h4>
